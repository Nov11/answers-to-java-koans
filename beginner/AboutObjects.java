...
public class AboutObjects {
	...
	public void newObjectInstancesCanBeCreatedDirectly() {
		assertEquals(new Object() instanceof Object, new Object().getClass() == Object.class);
	}
	...
	public void allClassesInheritFromObject() {
		...
		assertEquals(ancestors[0], new Foo().getClass());
	...
	public void objectToString() {
		...
		assertEquals(expectedToString, "java.lang.Object@"+String.format("%x", object.hashCode())); // hint: object.toString()
	}
